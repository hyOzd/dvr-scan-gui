...
3. Click **Scan for motion**. Progress shows in the bar below the button.
4. When the scan finishes, events appear on the seek bar and in the results
   table on the right.
5. **Double-click** any event to jump to it and start playback, or click once
